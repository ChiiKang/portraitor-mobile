...
class SetupNotifier extends StateNotifier<SetupState> {
  ...
  void setDateRange(DateTime start, DateTime end) {
    final filtered = DateParser.filterByDateRange(state.normalizedText, start, end);
    final filteredMessages = DateParser.countMessagesInRange(state.normalizedText, start, end);
