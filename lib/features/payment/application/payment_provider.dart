  ...
  PaymentState copyWith({
    ...
    return PaymentState(
      ...
      clientConversationRef:
          clientConversationRef ?? this.clientConversationRef,
...
class PaymentNotifier extends StateNotifier<PaymentState> {
  ...
  Future<bool> initiatePayment({
    ...
    try {
      final inputHash =
          normalizedText != null ? computeInputHash(normalizedText) : null;
      ...
      final payUrl = Uri.parse('$baseUrl/pay/').replace(
        queryParameters: {
      ...
      if (uri.host == 'payment-success') {
        ...
        final verifyData =
            verification['data'] as Map<String, dynamic>? ?? verification;
        final paid =
      ...
      debugPrint(
        '[Payment] ApiException: ${e.message} (status: ${e.statusCode})',
      );
