                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    _SettingsTile(
                      ...
                      onTap:
                          () => launchUrl(
                            Uri.parse('https://portraitor.ai/privacy'),
                          ),
                    ),
                    _SettingsTile(
                      ...
                      onTap:
                          () => launchUrl(
                            Uri.parse('https://portraitor.ai/terms'),
                          ),
                    ),
                    const SizedBox(height: 24),
    ...
    showDialog(
      ...
      builder:
          (ctx) => AlertDialog(
            ...
            content: const Text(
              'This will permanently remove all portraits from your device.',
            ),
            actions: [
              TextButton(
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: ListTile(
        ...
        title: Text(
          title,
          style: PortraitorTokens.bodyLg.copyWith(color: color),
        ),
        subtitle:
            subtitle != null
