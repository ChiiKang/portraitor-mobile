...
import 'package:portraitor_mobile/shared/widgets/gradient_text.dart';
...
class _HomeScreenState extends ConsumerState<HomeScreen>
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen(processingProvider, (prev, next) {
      if (prev?.status != ProcessingStatus.done &&
        ...
        child: SafeArea(
          child: CustomScrollView(
            slivers: [
              ...
              SliverToBoxAdapter(child: _HeroCTA(onTap: _openImportSheet)),
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: PortraitorTokens.brandPurple.withValues(alpha: 0.3),
          ),
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                const Icon(Icons.chevron_right, color: PortraitorTokens.inkDim),
              ],
            ),
          ),
        ),
